      ...
      <el-aside width="200px">
        ...
        >
          <el-sub-menu index="1-4">
            <template #title
              ><el-icon><OfficeBuilding /></el-icon> 集团管理</template
            >
            <el-menu-item index="/barnd">品牌管理</el-menu-item>
            <el-menu-item index="/shop">门店管理</el-menu-item>
            <el-menu-item index="/shopowner">店长管理</el-menu-item>
          </el-sub-menu>
        </el-menu>
      </el-aside>
      <!-- </div>
...
const title = ref("");
onBeforeMount(() => {
  title.value = localStorage.getItem("title")==undefined? '品牌管理':localStorage.getItem("title");
...
onBeforeRouteUpdate((to, from) => {
  ...
  keyDiv.value+=1;
  if (to.path == "/barnd/add" || to.path == "/shop/add" || to.path == "/shopowner/add") {
    data.goback = true;
